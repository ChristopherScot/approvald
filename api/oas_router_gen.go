				...
				case '/': // Prefix: "/"
					...
					case '/': // Prefix: "/"
						...
						if len(elem) == 0 {
							...
							switch r.Method {
							case "GET":
								s.handleTapConfirmRequest([3]string{
									args[0],
									args[1],
									args[2],
								}, elemIsEscaped, w, r)
							case "POST":
								s.handleTapRequest([3]string{
									args[0],
									args[1],
									args[2],
								}, elemIsEscaped, w, r)
				...
				case '/': // Prefix: "/"
					...
					case '/': // Prefix: "/"
						...
						if len(elem) == 0 {
							...
							switch method {
							case "GET":
								r.name = TapConfirmOperation
								r.summary = "The confirmation page a person lands on"
								r.operationID = "tapConfirm"
								r.operationGroup = ""
								r.pathPattern = "/d/{nonce}/{token}/{verb}"
								r.args = args
								r.count = 3
								return r, true
							case "POST":
								r.name = TapOperation
								r.summary = "Record the decision and publish it"
								r.operationID = "tap"
								r.operationGroup = ""
								r.pathPattern = "/d/{nonce}/{token}/{verb}"
								r.args = args
			...
			case 'h': // Prefix: "healthz"
				...
				if len(elem) == 0 {
					...
					case "GET":
						...
						r.summary = "Readiness and liveness"
			...
			case 'r': // Prefix: "register"
				...
				if len(elem) == 0 {
					...
					case "POST":
						...
						r.summary = "Register a nonce and mint its tap URLs"
